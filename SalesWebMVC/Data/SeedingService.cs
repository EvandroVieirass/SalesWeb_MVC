...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@email.com", new DateTime(1992,05,01), 1600.0, d1);
            Seller s2 = new Seller(2, "Ana Brown", "Ana@email.com", new DateTime(1982, 08, 21), 1700.0, d2);
            Seller s3 = new Seller(3, "Tommy Lee", "lee@email.com", new DateTime(1998, 06, 15), 1600.0, d1);
            Seller s4 = new Seller(4, "Maria Jones", "maria@email.com", new DateTime(1994, 11, 09), 1300.0, d3);
            Seller s5 = new Seller(5, "Adam Michael", "adam@email.com", new DateTime(1988, 04, 13), 1400.0, d4);
            Seller s6 = new Seller(6, "Lucas Miller", "lucas@email.com", new DateTime(1997, 12, 01), 1300.0, d3);
